...
<ul class="resume-contact">
	<li class="birthday">
		...
		<span>{calculateYearsSince(new Date('2002-11-28'))} years old</span>
	</li>
	<li class="experience">
	...
	<li class="location">
		...
		<span>Mishmarot, Israel</span>
	</li>
	<li class="email">
		<span class="icon"><EmailIcon /></span>
		<a href="mailto:yahavka12@gmail.com">yahavka12@gmail.com</a>
	</li>
	<li class="linkedin">
		<span class="icon"><LinkedInIcon /></span>
		<a
			href="https://www.linkedin.com/in/yahav-kadar/"
			target="_blank"
	...
	<li class="website">
		...
		<a href="https://yahavka12.com" target="_blank" rel="noopener noreferrer"> yahavka12.com </a>
	</li>
	<li class="github">
		<span class="icon"><GitHubIcon /></span>
		<a href="https://github.com/yahavka12" target="_blank" rel="noopener noreferrer">
			GitHub Profile
		</a>
	</li>
	<li class="languages">
		<span class="icon"><ChatIcon /></span>
		<span>English, Hebrew</span>
	</li>
</ul>
